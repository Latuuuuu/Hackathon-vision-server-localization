...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '640, 362, 30', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.color_profile',   'default': '640, 362, 30', 'description': 'Depth module color stream profile for d405'},
